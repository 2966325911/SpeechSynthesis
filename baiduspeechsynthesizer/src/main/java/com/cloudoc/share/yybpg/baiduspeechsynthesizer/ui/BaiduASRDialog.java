...
import com.cloudoc.share.yybpg.baiduspeechsynthesizer.voicedemo.recognization.IRecogListener;
import com.cloudoc.share.yybpg.baiduspeechsynthesizer.voicedemo.recognization.RecogResult;
...
public abstract class BaiduASRDialog extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkConfig();
        input = ((SimpleTransApplication) getApplicationContext()).getDigitalDialogInput();
